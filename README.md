...
Ready to start your coding journey? **[Visit SyntaxForge now!](https://syntaxforge.dev)**
...
- **Main Site**: [syntaxforge.dev](https://syntaxforge.dev)
- **Documentation**: [docs.syntaxforge.dev](https://docs.syntaxforge.dev)
- **Playground**: [syntaxforge.dev/editor](https://syntaxforge.dev/editor)
- **Courses**: [syntaxforge.dev/courses](https://syntaxforge.dev/courses)
...
- Built with [CodeMirror](https://codemirror.net/) for the code editor
...
<div align="center">
  <strong>Made with ❤️ by the SyntaxForge Team</strong>
</div>
